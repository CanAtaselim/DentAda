...
namespace DentAda.Common
{
    ...
    public class DentAda_Exception : Exception
    {
        ...
        public DentAda_Exception()
            : this(_Enumeration._TypeException.Common)
        {
        }

        public DentAda_Exception(_Enumeration._TypeException common)
        {
            this.common = common;
        }

        public DentAda_Exception(string message)
            : this(message, (int)_Enumeration._TypeException.Common)
        {
        }

        public DentAda_Exception(int errorCode)
            : this(String.Format("Error({0})", errorCode), errorCode)
        {
        }

        public DentAda_Exception(string message, int errorCode)
            : base(message)
        {
        ...
        public DentAda_Exception(string message, int errorCode, Exception innerException)
        ...
        public DentAda_Exception(string message, int errorCode, Exception innerException, _EventDetail _evntDetail)
            : base(message, innerException)
        {
            _errorCode = errorCode;
            if (innerException.InnerException != null)
        ...
        public DentAda_Exception(string message, int errorCode, Exception innerException, string errorDetail, _EventDetail _evntDetail)
            : base(message, innerException)
        {
            _errorCode = errorCode;
            if (innerException.InnerException != null)
        ...
        protected static void Save(int errorCode, string errorMessage, string functionCode, _EventDetail eventDetail)
        {
            ...
            DentAda_Logging.WriteToQueue(DentAda_Logging.Type.Exception, SerializeObject(ex));
        }
